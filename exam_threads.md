...
DeadLock - взаимная блокировка, то есть когда два потока бесконечно ждут друг друга, о, в результате чего приложение
сильно теряет в производительности, либо вообще перестает работать (зависает). То есть Deadlock - это взаимоблокировка
нитей.
